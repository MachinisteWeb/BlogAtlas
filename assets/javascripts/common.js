...
(function (publics) {
	...
	publics.disqusNumberLoading = function () {
		...
		script.async = true;
		script.src = "//lesieur.disqus.com/count.js";
	...
	publics.toggleMenu = function () {
		...
		menu.addEventListener("click", function () {
			menu.classList.toggle("is-displayed");
			if (main.classList.contains("is-displayed")) {
				main.classList.remove("is-displayed");
				setTimeout(function () {
					main.style['z-index'] = -1;
				}, 1000);
			} else {
				main.classList.add("is-displayed");
